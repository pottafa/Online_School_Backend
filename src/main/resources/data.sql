insert into courses(id, title, description ) values (103, 'Java SE', 'Курс по Java SE');
...
insert into courses(id, title, description) values(104, 'Spring', 'Курс по Spring Framework');
...
insert into courses(id, title, description) values(105, 'Spring Boot', 'Курс по Spring Boot');

insert into courses(id, title, description) values (106, 'Java Script', 'Курс по JS');
...
insert into users (id, login, password, email) values (116, 'student', '$2y$12$xAJNHHpZxsHQWDTBY9oVouIZgfAM3DrqIxW1J/s/wgvpv6G12Jr36', 'pottafa.spam@gmail.com'  );
...
Password: otus
*/
insert into users (id, login, password, email) values (117, 'admin', '$2y$12$xAJNHHpZxsHQWDTBY9oVouIZgfAM3DrqIxW1J/s/wgvpv6G12Jr36', 'pottafa.spam!@gmail.com' );
